...
class Import extends React.Component {
  ...
  handleFilter = (e: any) => {
    ...
    if (value.length) {
      filteredData = data.filter((col: any) => {
        let keys: any = Object.keys(col);

        let startsWithCondition: any = keys.filter((key: any) => {
          return col[key]
            .toString()
            .toLowerCase()
        ...
        let includesCondition = keys.filter((key: any) =>
