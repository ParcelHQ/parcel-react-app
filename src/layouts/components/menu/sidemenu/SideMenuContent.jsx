...
//       temp_arr.push(id);
//     } else if (type === 'collapse' && parent !== null) {
//       if (active_group.includes(parent)) temp_arr = active_group.slice(0);

//       if (temp_arr.includes(id)) {
//         // temp_arr.splice(temp_arr.indexOf(id), 1)
//         temp_arr.splice(temp_arr.indexOf(id), temp_arr.length);
//       } else temp_arr.push(id);
//     } else temp_arr = [];
...
//         let temp = open_group.filter((obj: any) => {
//           return active_group.indexOf(obj) === -1;
//         });
//         // Remove those unmatched items from open group
//         if (temp.length > 0 && !open_group.includes(parent)) {
//           open_group = open_group.filter((obj: any) => {
...
//       }
//     }
//     if (type === 'item') open_group = active_group.slice(0);
